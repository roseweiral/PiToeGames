...
bricks = [(pygame.Rect(100 * i, 50, 80, 20), color[i % len(color)]) for i in range(5)]
...
def game_over_screen():
    while True:
        ...
        press_any_key_text = font.render("Press any key to return to the menu", True, WHITE)

        screen.blit(game_over_text, (WIDTH // 2 - game_over_text.get_width() // 2, HEIGHT // 3))
        screen.blit(press_any_key_text, (WIDTH // 2 - press_any_key_text.get_width() // 2, HEIGHT // 2))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                sys.exit()
            if event.type == pygame.KEYDOWN:
                return  # Go back to the menu after any key press

#==============================================================================#
# Main Game Loop - Modified to Call Game Over Screen
#==============================================================================#
...
while True:
    ...
    if ball.bottom >= HEIGHT:
        ...
        if lives == 0:
            ...
            game_over_screen()  # Display the game over screen and wait for key press
    ...
    for brick, brick_color in bricks:  # Unpack the brick and its color
        pygame.draw.rect(screen, brick_color, brick)  # Draw the brick using its color and rect
