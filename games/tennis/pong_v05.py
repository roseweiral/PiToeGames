...
# Paddle settings
PADDLE_WIDTH = 10
PADDLE_HEIGHT_PLAYER1 = 100  # Player 1 paddle height
PADDLE_HEIGHT_PLAYER2 = 100  # Player 2 paddle height
PADDLE_SPEED_PLAYER1 = 5     # Player 1 paddle speed
PADDLE_SPEED_PLAYER2 = 5     # Player 2 paddle speed
...
player1 = pygame.Rect(50, (HEIGHT - PADDLE_HEIGHT_PLAYER1) // 2, PADDLE_WIDTH, PADDLE_HEIGHT_PLAYER1)
player2 = pygame.Rect(WIDTH - 50 - PADDLE_WIDTH, (HEIGHT - PADDLE_HEIGHT_PLAYER2) // 2, PADDLE_WIDTH, PADDLE_HEIGHT_PLAYER2)
...
while True:
    ...
    if fsr_value_up > fsr_threshold and player1.top > 0:
        player1.y -= PADDLE_SPEED_PLAYER1
    ...
    if keys[pygame.K_UP] and player2.top > 0:
        player2.y -= PADDLE_SPEED_PLAYER2
